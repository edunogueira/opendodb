...
class PlayerScraperInactive:
    ...
    async def process_players(self, batch_size=20):
        clubinfo = self.db.get_clubinfo_with_is_inactive()
...
async def main():
    # Instancia o PlayerScraperInactive
    scraper = PlayerScraperInactive()
